    ...
    async execute(message) {
        ...
        let content =
            message.attachments.size > 0
                ? `${date} => [${message.author.username}#${message.author.discriminator}] deleted [${message.content}] | Attachment(s) => `
                : `${date} => [${message.author.username}#${message.author.discriminator}] deleted [${message.content}]\n`;
